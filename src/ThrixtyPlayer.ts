    ...
    constructor(root_elem: HTMLElement) {
        ...
        this.DOM_obj = {
            ...
            controls: Thrixty.create_element("<div class='thrixty_controls'></div>"),
                ...
                prev_btn: Thrixty.create_element("<button type='button' id='prev_btn_" + (this.player_id + 1) + "' class='ctrl_buttons thrixty_prev_btn'></button>"),
                ...
                play_btn: Thrixty.create_element("<button type='button' id='play_btn_" + (this.player_id + 1) + "' class='ctrl_buttons thrixty_play_btn' thrixty-state='pause'></button>"),
                ...
                next_btn: Thrixty.create_element("<button type='button' id='next_btn_" + (this.player_id + 1) + "' class='ctrl_buttons thrixty_next_btn'></button>"),
                ...
                zoom_btn: Thrixty.create_element("<button type='button' id='zoom_btn_" + (this.player_id + 1) + "' class='ctrl_buttons thrixty_zoom_btn' thrixty-state='zoomed_out'></button>"),
                ...
                size_btn: Thrixty.create_element("<button type='button' id='size_btn_" + (this.player_id + 1) + "' class='ctrl_buttons thrixty_size_btn' thrixty-state='normalsized'></button>"),
                ...
                close_btn: Thrixty.create_element("<button type='button' id='close_btn_" + (this.player_id + 1) + "' class='thrixty_close_btn'></button>"),
            ...
            load_overlay: Thrixty.create_element("<div id='load_overlay_" + (this.player_id + 1) + "' class='thrixty_load_overlay'></div>"),
                load_btn: Thrixty.create_element("<button type='button' id='load_btn_" + (this.player_id + 1) + "' class='thrixty_load_btn'></button>"),
